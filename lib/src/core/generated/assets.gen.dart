...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/face_ball.png
  AssetGenImage get faceBall =>
      const AssetGenImage('assets/images/face_ball.png');
  ...
  /// File path: assets/images/mindsetUbulb.png
  AssetGenImage get mindsetUbulb =>
      const AssetGenImage('assets/images/mindsetUbulb.png');

  /// File path: assets/images/mindset_logo.png
  AssetGenImage get mindsetLogo =>
      const AssetGenImage('assets/images/mindset_logo.png');

  /// File path: assets/images/phone.svg
  SvgGenImage get phone => const SvgGenImage('assets/images/phone.svg');

  /// File path: assets/images/racket.png
  AssetGenImage get racket => const AssetGenImage('assets/images/racket.png');
